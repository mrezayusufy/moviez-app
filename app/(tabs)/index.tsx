...
import { ActivityIndicator, FlatList, Image, ScrollView, Text, View, RefreshControl, TouchableOpacity } from "react-native";
export default function Index() {
  const router = useRouter();
  const { data: movies, loading: mLoading, error: mError } = useFetch(() => getMovies({ query: '' }));
